...
Ext.onReady(function() {
	...
	Ext.define('App.ContractReportWin', {
					...
					items : [ {
						...
						listeners : {
							select : function(combo, record, index) {
								Ext.getCmp("contractreportform-role").setValue(combo.getValue());
							}
						}
					}, {
						xtype : 'hiddenfield',
						id : 'contractreportform-role',
						name : 'role'
					} ],
					buttons : [ '->', {
						id : 'contractreportwindow-save',
						text : '保存',
						iconCls : 'icon-save',
						width : 80,
									...
									success : function(response) {
										if (response.responseText != '') {
											...
											if (res.success) {
												...
												Ext.getCmp('contractreportgrid').getStore().reload();
											} else {
						...
						id : 'contractreportwindow-cancel',
						text : '取消',
						iconCls : 'icon-cancel',
						width : 80,
						handler : function() {
						...
						id : 'contractreportwindow-accept',
						text : '确定',
						hidden : true,
						iconCls : 'icon-accept',
						width : 80,
	...
	Ext.define('Cscec.app.contract.ContractReport', {
		...
		onViewClick : function() {
			var grid = Ext.getCmp("contractreportgrid");
			...
			Ext.getCmp('contractreportwindow-save').hide();
			Ext.getCmp('contractreportwindow-cancel').hide();
			Ext.getCmp('contractreportwindow-accept').show();
			win.show();
		}
	});
});