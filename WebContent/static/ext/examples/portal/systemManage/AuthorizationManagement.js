// 权限管理
Ext.define('Cscec.app.systemManage.AuthorizationManagement', {
	extend : 'Ext.panel.Panel',
	initComponent : function() {
		var me = this;
		Ext.apply(this, {
			layout : 'border',
			items : [ Ext.create('Cscec.app.systemManage.AuthorizationManagement.SysUserGrid', {
				cButtons : me.cButtons,
				cName : me.cName
			}), Ext.create('Cscec.app.systemManage.AuthorizationManagement.MenuTree') ]
		});
...
// 角色列表
Ext.define('Cscec.app.systemManage.AuthorizationManagement.SysUserGrid', {
	...
	initComponent : function() {
		...
		var sysusergridstore = Ext.create('Ext.data.Store', {
			...
			proxy : {
				type : 'ajax',
				url : appBaseUri + '/sys/role/getRoleNameList',
...
// 树形菜单
Ext.define('Cscec.app.systemManage.AuthorizationManagement.MenuTree', {
